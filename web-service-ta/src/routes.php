...
return function (App $app) {
    ...
    $app->post('/sessionSignIn', function ($request, $response) {
        ...
        if($result==true){
            ...
            $sql = "SELECT u.id_user,u.password_user,u.nama_user,u.telpon_user,u.status_user,u.premium_available_until,u.lokasi_aktif_user,u.id_kecamatan_user,u.status_aktif_user,k.nama_kecamatan 
